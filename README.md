...
Run the integration tests with Cypress. You can prompt the Cypress UI for interactive testing by default with `yarn cypress` and kick off single-run tests for Continuous Integration with `yarn cypress:ci`.
...
### Additional Create React App docs
